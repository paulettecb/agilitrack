...
const OPTS = [{value:"clean",label:"Limpia",color:"#00C896",emoji:"â"},{value:"faults",label:"Con faltas",color:"#FF6B35",emoji:"â ï¸"},{value:"eliminated",label:"Eliminada",color:"#FF6B35",emoji:"<div>â</div>"},{value:"dnf",label:"No terminÃ³",color:"#8892A4",emoji:"ç§»ï¸"}];
  ...
  return (
    <div className="flex min-h-screen" style={{background:"#1A1A2E"}}>
      ...
      <main className="flex-1 p-8 max-w-2xl">
        <div className="mb-8"><h1 className="text-2xl font-bold text-white">Registrar sesiÃ³n</h1><p className="text-sm mt-1" style={{color:"#8892A4"}}>Guarda tiempo, faltas y notas</p></div>
