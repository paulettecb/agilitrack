    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-6"
      ...
      <div className="text-center max-w-lg">
        <div className="mb-8 flex items-center justify-center gap-3">
          <div className="w-12 h-12 rounded-xl flex items-center justify-center text-2xl" style={{ background: "#E8FF47" }}>ð¾</div>
          <div>
            <div className="text-2xl font-bold text-white">AgiliTrack</div>
            <div className="text-xs" style={{ color: "#8892A4" }}>by KYN Studio</div>
          </div>
        </div>
        <h1 className="text-4xl font-bold text-white mb-4">Entrena. DiseÃ±a. Compite.</h1>
        ...
        <div className="mt-16 grid grid-cols-3 gap-6 text-center">
          {[{ emoji: "ð", label: "Constructor de pistas FCI" },{ emoji: "ð", label: "Registro de sesiones" },{ emoji: "ð", label: "Historial de competencias" }].map((f) => (
